...
public class FlightDAO {
	...
	public List<Airport> getAirportNoRoute(Map<Integer,Airport> map){
		String sql = "select airport.Airport_ID "+
				"from airport "+
				"where airport.Airport_ID not in(select distinct route.Source_airport_ID from route ) and airport.Airport_ID not in (select distinct route.Destination_airport_ID  from route)";
